...
function gup( name, url, defaultVal ) {
	console.log("正在运行 in coconncaller.js", arguments.callee.name)
...
function loadConfig(){
	...
	client.open("GET", "playzool.com/common/loadGameConfig?gamename="+_gamename+"&clientID="+_clientID+"&platform="+_platform, true);
	client.send();
	//alert('send');
}
