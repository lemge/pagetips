function createUnityInstance(e, t, r) {
    ...
    function l(e, t) {
        return new Promise(function (r, n) {
            try {
                for (var o in w) if (w[o].hasUnityMarker(e)) {
                    ...
                    return a.worker.callbacks[s] = r, void a.worker.postMessage({id: s, compressed: e}, [e.buffer])
                }
                r(e)
            } catch (e) {
                n(e)
    ...
    function d(e) {
        s(e);
        var t = f.cacheControl(f[e]), r = f.companyName && f.productName ? f.cachedFetch : f.fetchWithProgress,
            o = f[e], a = /file:\/\//.exec(o) ? "same-origin" : void 0, i = r(f[e], {
                method: "GET",
    ...
    var p = {
        Module: f, SetFullscreen: function () {
    ...
    f.SystemInfo = function () {
        ...
        for (var t, r, n, o, a, i, s = navigator.userAgent + " ", l = [["Firefox", "Firefox"], ["OPR", "Opera"], ["Edg", "Edge"], ["SamsungBrowser", "Samsung Browser"], ["Trident", "Internet Explorer"], ["MSIE", "Internet Explorer"], ["Chrome", "Chrome"], ["CriOS", "Chrome on iOS Safari"], ["FxiOS", "Firefox on iOS Safari"], ["Safari", "Safari"]], d = 0; d < l.length; ++d) if (r = e(l[d][0] + "[/ ](.*?)[ \\)]", s, 1)) {
            t = l[d][1];
            break
        }
            ...
            return r && r.onProgress && (n = r.onProgress), fetch(t, r).then(function (t) {
                function r() {
                    return "undefined" == typeof a ? t.arrayBuffer().then(function (e) {
                        return n({type: "progress", total: e.length, loaded: 0, lengthComputable: i}), new Uint8Array(e)
                ...
                var a = "undefined" != typeof t.body ? t.body.getReader() : void 0,
                    i = "undefined" != typeof t.headers.get("Content-Length"), s = e(t, i), l = new Uint8Array(s),
                    d = [], u = 0, c = 0;
                ...
                return new Promise(function (n, o) {
                    try {
                        ...
                        var a = ["put", "delete", "clear"].indexOf(t) != -1 ? "readwrite" : "readonly",
                            i = this.database.transaction([e], a), s = i.objectStore(e);
        ...
        function i(i, u) {
            ...
            var h = s.getInstance(), b = t("string" == typeof i ? i : i.url), m = {enabled: a(b, u)};
            return u && (m.control = u.control, m.company = u.company, m.product = u.product), m.result = o(b, m.company, m.product, Date.now()), m.revalidated = !1, m.enabled ? h.loadRequest(m.result.url).then(function (t) {
                ...
                if (r(m.result.url) && (o.headers.get("Last-Modified") || o.headers.get("ETag"))) return fetch(m.result.url, {method: "HEAD"}).then(function (t) {
        ...
        var s = f.UnityCache, l = s.RequestStore, d = f.fetchWithProgress;
            ...
            require: function (e) {
                var t = {
                    "inflate.js": function (e, t, r) {
                        ...
                        var i = e("./zlib/inflate"), s = e("./utils/common"), l = e("./utils/strings"),
                            d = e("./zlib/constants"), u = e("./zlib/messages"), c = e("./zlib/zstream"),
                            f = e("./zlib/gzheader"), h = Object.prototype.toString;
                        n.prototype.push = function (e, t) {
                            var r, n, o, a, u, c, f = this.strm, b = this.options.chunkSize,
                                m = this.options.dictionary, g = !1;
                        ...
                        s[254] = s[254] = 1, r.string2buf = function (e) {
                            ...
                            for (o = 0, r = 0; r < l;) if (a = e[r++], a < 128) d[o++] = a; else if (i = s[a], i > 4) d[o++] = 65533, r += i - 1; else {
                        ...
                        function u(e) {
                            if (ve) {
                                ...
                                for (x(S, e.lens, 0, 288, g, 0, e.work, {bits: 9}), t = 0; t < 32;) e.lens[t++] = 5;
                        ...
                        function f(e, t) {
                            var r, o, a, i, s, l, d, f, h, b, m, g, p, me, ge, pe, we, ve, ye, ke, xe, _e, Se, Ee,
                                Ce = 0, Be = new w.Buf8(4),
                            ...
                            e:for (; ;) switch (r.mode) {
                                case z:
                                    ...
                                    if (f >>>= 4, h -= 4, xe = (15 & f) + 8, 0 === r.wbits) r.wbits = xe; else if (xe > r.wbits) {
                                ...
                                case te:
                                    for (; r.have < r.nlen + r.ndist;) {
                                        ...
                                        if (we < 16) f >>>= ge, h -= ge, r.lens[r.have++] = we; else {
                                            if (16 === we) {
                                                for (Ee = ge + 2; h < Ee;) {
                                                    if (0 === l) break e;
                                                    l--, f += o[i++] << h, h += 8
                        ...
                        var g, p, w = e("../utils/common"), v = e("./adler32"), y = e("./crc32"), k = e("./inffast"),
                            x = e("./inftrees"), _ = 0, S = 1, E = 2, C = 4, B = 5, U = 6, T = 0, R = 1, L = 2, O = -2,
                            I = -3, A = -4, P = -5, D = 8, z = 1, N = 2, F = 3, Z = 4, j = 5, H = 6, M = 7, W = 8,
                            G = 9, q = 10, K = 11, V = 12, Y = 13, Q = 14, X = 15, J = 16, $ = 17, ee = 18, te = 19,
                            re = 20, ne = 21, oe = 22, ae = 23, ie = 24, se = 25, le = 26, de = 27, ue = 28, ce = 29,
                            fe = 30, he = 31, be = 32, me = 852, ge = 592, pe = 15, we = pe, ve = !0;
                        ...
                        t.exports = function (e, t) {
                            ...
                            e:do {
                                ...
                                t:for (; ;) {
                                    if (x = k >>> 24, m >>>= x, g -= x, x = k >>> 16 & 255, 0 === x) U[s++] = 65535 & k; else {
                                        if (!(16 & x)) {
                                            if (0 === (64 & x)) {
                                                k = p[(65535 & k) + (m & (1 << x) - 1)];
                                                continue t
                        ...
                        "use strict";
                        var n = e("../utils/common"), o = 15, a = 852, i = 592, s = 0, l = 1, d = 2,
                        ...
                        t.exports = function (e, t, r, b, m, g, p, w) {
                            var v, y, k, x, _, S, E, C, B, U = w.bits, T = 0, R = 0, L = 0, O = 0, I = 0, A = 0, P = 0,
                                D = 0, z = 0, N = 0, F = null, Z = 0, j = new n.Buf16(o + 1), H = new n.Buf16(o + 1),
                                M = null, W = 0;
                            for (T = 0; T <= o; T++) j[T] = 0;
                            ...
                            for (L = 1; L < O && 0 === j[L]; L++) ;
                            for (I < L && (I = L), D = 1, T = 1; T <= o; T++) if (D <<= 1, D -= j[T], D < 0) return -1;
