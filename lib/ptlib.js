...
var autoCatalog2={
    ...
    getDataByEle:function (){
        ...
        for (var i=0;i<hs.length;i++){
            ...
            if(hs[i].className.indexOf('pt-ac-ff') > -1){
                tmp_link['ex']['class']='pt-ac-ff'
            }else if(hs[i].className.indexOf('pt-ac-fc') > -1){
    ...
    setCataLogDom:function (){
        ...
        function stru_hlele(now_stru_ele){
            ...
            if(now_stru_ele['ex']['class']==='pt-ac-ff'){
            ...
            hlele.classList.add(now_stru_ele['ex']['class'])
            hlele.append(hlelea)
            return hlele;
        }
        console.log(this.catalogData)
        ...
        for(var i=0;i<this.catalogData.length;i++){
            ...
            if(now_stru_ele['ex']['class']==='pt-ac-fc'){
                folder_box=document.createElement('div')
                folder_box.classList.add('pt-ac-folder-box')
                while(i<this.catalogData.length){
                    now_stru_ele=this.catalogData[i];
                    if(now_stru_ele['ex']['class']==='pt-ac-comele')
                    {
                        break;
                    }
